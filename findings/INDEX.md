...
|----|------|----------|--------|-------|
| BUG-001 | bug | major | open | Rumor spread system non-functional |
| BUG-002 | bug | major | open | Screenshot (F12) produces black image |
...
| DESIGN-001 | design | minor | open | North Watchtower is a dead-end |
